...
// func getCurves(rand float64, tileset []tileSet, edgeMap edgePointMapping, endpointMap map[int]float64) []*Curve {
// 	l := len(truchetUnderPairs)
// 	n := int(val * float64(l))
// 	if n == l {
// 		n = n - 1
// 	}
// 	tileSet := truchetUnderPairs[n]
// 	ret := make([]*Curve, len(tileSet.pairs))
