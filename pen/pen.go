...
var (
	...
	Micron05  = Pen{"Micron 05", 15, 0, 0}
	Micron10  = Pen{"Micron 10", 20, -5, 15}
	...
	SharpieCreativeMarker = Pen{"Sharpie Creative Marker", 25, 20, -75} // displacement can change depending on positioning
